        ...
        try {
            ...
            if (!\Utill\Dal\Helper::haveRecord($kontrol)) { 
                ...
                if (!\Utill\Dal\Helper::haveRecord($opUserId)) {
                    ...
                    $sql = " 
                    declare  @oidvv varbinary(200);
                    set   @oidvv = /* Crypt_Gen_Random((10)); */ 
                    CONVERT(char(20),Crypt_Gen_Random((10)), 2);
                    ...
                    VALUES (   
                            '".$username."', 
                            ENCRYPTBYPASSPHRASE(@oidvv, N'".$password."', 2, '".$username."'), 
                    ...
                    $insertID = $pdo->lastInsertId('info_users');
                    $errorInfo = $statement->errorInfo();
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
